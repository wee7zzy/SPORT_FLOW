...
<body class="bg-gray-100">
    ...
    <section class="container mx-auto px-6 py-16 text-center">
        <h3 class="text-3xl font-bold mb-6">Vos Séances de Coaching</h3>
        <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
            <thead>
                <tr>
                    <th class="px-6 py-3 text-left text-sm font-semibold text-gray-700">Nom du Client</th>
            ...
            <tbody>
                <%
                    ...
                    List<utilisateurs> coaches = dao.getClientsForCoach(session.getAttribute("name").toString());
